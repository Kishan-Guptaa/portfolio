...
const allProjects = [
  ...
  {
    title: "Weather App",
    description: "Fetches real-time weather data using OpenWeatherMap API and shows current conditions in any city.",
    tech: ["React", "API", "Tailwind CSS"],
    live: "https://weather-kishan.vercel.app",
    github: "https://github.com/yourusername/weather-app",
    image: "/images/weather.png",
  },
  {
    title: "Portfolio Website",
    description: "Fully responsive personal portfolio showcasing skills, projects, and resume download feature.",
    tech: ["React", "Tailwind CSS"],
    live: "https://kishanportfolio.vercel.app",
...
export default function AllProjects() {
  return (
    <section className="bg-black text-white min-h-screen px-4 sm:px-8 md:px-20 pt-20 pb-28">
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-12 text-center text-gray-500">
        All Projects
      </h2>
